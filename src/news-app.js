  ...
  static get template() {
    ...
    <style>
      ...
      :host {
        ...
        --app-feature-border-style: 10px solid;
        --app-transparent-border-style: 1px solid rgba(255, 255, 255, 0.5);
        --app-button-border-style: 2px solid #222;
        --app-cover-text-color: #FFF;
        --app-nav-background-color: #AA00FF;
        --app-nav-text-color: #FFF;
        --app-nav-deselected-text-color: #EEE;
        --app-nav-selected-background-color: #673AB7;
        --app-light-mode: #E0E0E0;
        --app-light-mode-card: white;
        --app-light-mode-card-text-color: black;
        --app-light-mode-background-color: #EEEEEE;
        --app-light-mode-text-color: black;
        --app-dark-mode-card: white;
        --app-dark-mode-card-text-color: black;
        --app-dark-mode-background-color:  #212121;
        --app-dark-mode-text-color: white;
    ...
    <news-analytics key="UA-57421859-2"></news-analytics>
...
<iron-pages role="main" selected="[[page]]" attr-for-selected="name" fallback-selection="path-warning">
      ...
      <!-- article view -->
      <news-article class="article" name="article" route="{{subroute}}" category-name="{{categoryName}}" category="[[category]]" article-id="{{articleId}}" article="[[article]]" loading="[[loading]]" offline="[[offline]]" failure="[[failure]]"><slot></slot></news-article>
...
`;
  ...
  _setPageMetadata(description, article) {
    let image = article ? article.imageUrl : 'images/A-hAAn128.png';
